...
export default function Home() {
  ...
  const clear=useCallback(()=>{epoch.current++;setMe(null);setPage("identity");setMatch(null);setLinks([]);setAthlete(null);setDetail(null);setDraft(undefined);setRecordKey(k=>k+1);setEditingProfile(false);setMatching(false);},[]);
